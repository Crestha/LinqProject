...
namespace LinqProject.Classes
{
    public class SortingOperations
    {
        ...
        public void ThenBy()
        {
            ...
            Console.WriteLine("3. ThenByMethod()-Sorting Employee Names and then by Salary in Ascending Order: ");
        ...
        public void ThenByDescending()
        {
            ...
            Console.WriteLine("4. ThenByDescendingMethod()-Sorting Employee Names and then by Salary in Descending Order: ");
        ...
        public void Reverse()
        {
            ...
            Console.WriteLine("5. ReverseMethod()-Reverse order of Employee Names List: ");
